...
const Button = ({ to, label, light = false, outline = false, customClass }) => {
    const typeClasses = outline ? "text-slate-100 bg-transparent border-4 border-slate-100 hover:bg-slate-100 hover:text-slate-600" : light ? "text-slate-600 bg-slate-100" : "text-slate-200 bg-slate-700";
